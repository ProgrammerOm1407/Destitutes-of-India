...
function createPostCard(post) {
    ...
    card.innerHTML = `
        <img src="${post.imageUrl}" alt="Destitute photo" class="post-image" onclick="openInMaps(${post.gpsCoordinates.latitude}, ${post.gpsCoordinates.longitude})">
        <div class="post-info">
            ...
            <div class="post-address">
                ${post.locationDetails?.city ? `${post.locationDetails.city}, ` : ''}
                ${post.locationDetails?.state ? post.locationDetails.state : ''}
            </div>
        </div>
    `;
